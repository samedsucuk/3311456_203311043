...
import 'camping_places_detay.dart';
import 'package:http/http.dart' as http;

class CampingPlaces extends StatefulWidget {
  const CampingPlaces({Key? key}) : super(key: key);

  @override
  State<CampingPlaces> createState() => _CampingPlacesState();
}

class _CampingPlacesState extends State<CampingPlaces> {
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                ...
                return ListView.builder(
                    itemCount: kategoriList[0].veri.length,
                          ...
                          child: Card(
                              ...
                              child: Padding(
                                  ...
                                  child: ListTile(
                                    ...
                                    title:
                                        Text(kategoriList[0].veri[index].title),
                                  ))));
                    });
