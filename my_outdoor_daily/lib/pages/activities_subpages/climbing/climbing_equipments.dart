...
import 'climbing_equipments_detay.dart';
import 'package:http/http.dart' as http;

class ClimbingEquipments extends StatefulWidget {
  const ClimbingEquipments({Key? key}) : super(key: key);

  @override
  State<ClimbingEquipments> createState() => _ClimbingEquipmentsState();
}

class _ClimbingEquipmentsState extends State<ClimbingEquipments> {
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                ...
                return ListView.builder(
                    itemCount: kategoriList[4].veri.length,
                          ...
                          child: Card(
                              ...
                              child: Padding(
                                  ...
                                  child: ListTile(
                                    ...
                                    title:
                                        Text(kategoriList[4].veri[index].title),
                                  ))));
                    });
